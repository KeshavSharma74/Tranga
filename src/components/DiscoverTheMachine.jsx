...
      <div className='max-w-[1750px] mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28'>
...
              {fragrancePodData.features.map((feature, index) => (
...
            transition={{ duration: 0.8, delay: 0.3, ease: "easeOut" }}
            viewport={{ once: true, amount: 0.3 }}
            className="flex items-center justify-center lg:h-full lg:order-first"
          >
...
            </motion.p>
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {conveniencePodData.features.map((feature, index) => (
                <FeatureCard key={index} {...feature} />
              ))}
            </div>
          </div>
