          ...
          <div className="flex flex-col w-full justify-center gap-8 text-center">
            ...
            >
              ...
              <ScrollLink
                ...
                smooth={true}
                offset={-80}
                duration={800} // slowed scroll for smoother feel
              ...
              >
                <motion.button
                  ...
                  initial={false}
                  style={{
                    backgroundColor: '#FF9178', // Burnt Orange
                    color: '#14132C', // Dark Blue text
                  }}
                  whileHover={{
                    scale: 1.05,
                    backgroundColor: '#FFFD3A', // Electric Yellow on hover
                    boxShadow: '0 10px 25px rgba(255, 253, 58, 0.3)'
                  }}
                  whileTap={{ scale: 0.98 }}
              ...
              >
                <motion.button
                  ...
                  style={{
                    ...
                    color: '#14132C',
                    border: '2px solid #14132C'
                  }}
                  whileHover={{
                    scale: 1.05,
                    backgroundColor: '#14132C', // Dark Blue background on hover
                    color: '#FFFFFF',
                    boxShadow: '0 8px 20px rgba(20,19,44,0.12)'
                  }}
                  whileTap={{ scale: 0.98 }}
                  transition={{ duration: 0.18 }}
                  className="font-semibold py-3 px-8 rounded-full inline-block text-center w-full text-xl md:text-2xl h-full"
                >
