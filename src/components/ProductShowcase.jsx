...
const conveniencePodData = {
  ...
  revenue: "Venues earn on average $68,800 over a three year period with our retention pods.",
...
const fragrancePodData = {
  ...
  revenue: "Venues earn on average $73,080 over a three year period with our reset pods.",
    ...
    <div id="discover-the-pods" className="bg-gradient-to-br from-green-100 via-sky-100 to-purple-100 overflow-hidden">
      <div className='max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 text-center'>
        ...
        <div id="convenience-pod" className="mt-24">
            ...
            <motion.p initial={{ y: 50, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 0.8, delay: 0.2 }} viewport={{ once: true }} className="mt-4 text-lg text-gray-800 font-semibold max-w-3xl mx-auto">
                {conveniencePodData.revenue}
            </motion.p>
        </div>
